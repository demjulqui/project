...
export const fetchSingleMovie = (movieId) =>
	BASE_AXIOS.get(`https://api.themoviedb.org/3/movie/${movieId}?api_key=${API_KEY}`);

export const fetchSingleMovieCredits = (movieId) =>
	BASE_AXIOS.get(`https://api.themoviedb.org/3/movie/${movieId}/credits?api_key=${API_KEY}`);
export const fetchReviews = (movieId) =>
	BASE_AXIOS.get(`https://api.themoviedb.org/3/movie/${movieId}/reviews?api_key=${API_KEY}`);
...
export const fetchPopularMovie = () => BASE_API.get(`movie/popular?api_key=${API_KEY}`);

export const fetchTopRatedMovie = () => BASE_API.get(`movie/top_rated?api_key=${API_KEY}`);

export const fetchSort = (sort_date_to, sort_date_from, sort_genre, sort_choose) =>
	BASE_API.get(
...
export const fetchSortFilterDiscover = (sort_date_to, sort_date_from, sort_genre, sort_choose) =>
	BASE_API.get(
